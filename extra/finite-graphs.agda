...
module extra.finite-graphs where

import extra.unordered-pairs
open extra.unordered-pairs public
...
neighbor-Graph-𝔽 G x = Σ (vertices-Graph-𝔽 G) (λ y → type-trunc-Prop {!Σ (unordered-pair (vertices-Graph-𝔽 G)) (λ p → Σ (edges-Graph-𝔽 G!})
